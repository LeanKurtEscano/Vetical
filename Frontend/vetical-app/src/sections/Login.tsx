...
const Login: React.FC = () => {
  ...
  return (
    ...
    <div className="flex flex-col p-6 bg-white border-1 border-amber-500 rounded-lg shadow-2xl w-[400px]">
      ...
      <p className="text-center text-gray-600 mb-4">Sign up or log in to continue</p>
